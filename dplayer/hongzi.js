    ...
    function (e, t) {
        ...
        return function (e) {
            ...
            function (e, t, a) {
                ...
                e.exports = function (e) {
                    ...
                    i.danmaku && (t += '\n        <span class="dplayer-danloading">', t += l(s("Danmaku is loading")), t += "</span>\n        "),
                        ...
                        t += d.play,
                        t += '</span>\n        </button>\n   <button class="dplayer-icon dplayer-next-icon" style="display:none;" onclick="toNext()">\n    <svg id="n-next" viewBox="0 0 18 18" width="100%" height="100%"> <path d="M11.626 6.457L3.452 1.334C1.937.384.042 1.571.042 3.471v11.057c0 1.9 1.894 3.087 3.41 2.137l8.174-5.123c1.875-1.174 1.875-3.91 0-5.085zM16.5 1c-.825 0-1.5.675-1.5 1.5v13c0 .825.675 1.5 1.5 1.5s1.5-.675 1.5-1.5v-13c0-.825-.675-1.5-1.5-1.5z"></path></svg></button>\n     <button class="dplayer-icon dplayer-loop-icon">\n        <input class="dplayer-loop-input" type="checkbox" style="display:none">\n        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">\n' +
                    ...
                    i.video.quality && (t += '\n        <div class="dplayer-quality">\n            <button class="dplayer-icon dplayer-quality-icon">', t += l(i.video.quality[i.video.defaultQuality].name), t += '</button>\n            <div class="dplayer-quality-mask">\n                <div class="dplayer-quality-list">\n                ', c(i.video.quality, (function (e, a) {
                        ...
                        t += '<div class="dplayer-speed"><div class="dplayer-speed-lable-bg"><div class="dplayer-speed-lable"><p class="dplayer-speed-switch" data-speed="3.0">3.0x</p><p class="dplayer-speed-switch" data-speed="2.0">2.0x</p><p class="dplayer-speed-switch" data-speed="1.5">1.5x</p><p class="dplayer-speed-switch" data-speed="1.25">1.25x</p><p class="dplayer-speed-switch" data-speed="1.0">1.0x</p><p class="dplayer-speed-switch" data-speed="0.75">0.75x</p><p class="dplayer-speed-switch" data-speed="0.5">0.5x</p></div></div><button class="dplayer-icon dplayer-speed-icon"><span class="dplayer-icon-content">倍速</span></button></div>',
            ...
            function (e, t, a) {
                var n = a(35),
                    r = a(36);
                "string" == typeof (r = r.__esModule ? r.default :
                    r) && (r = [[e.i, r, ""]]);
                var o = {
                        insert: "head",
                        singleton: !1
            ...
            function (e, t, a) {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.player.template.volumeBarLine.addEventListener("click", (function (t) {
                                    ...
                                    this.player.video.addEventListener("enterpictureinpicture", function (pipWindow) {
                                        p = 1
                                    }),
                                    this.player.video.addEventListener("leavepictureinpicture", function (pipWindow) {
                                        p = 0
                                    }),
                ...
                var ve = function () {
                    function e(t) {
                        ...
                        if (!this.unlimitDanmaku) {
                            this.player.template.unlimitDanmaku.classList.add("off")
                        } else {
                            this.player.template.unlimitDanmaku.classList.remove("off")
                        }
                        ;
                        this.player.template.unlimitDanmaku.addEventListener("click", (function () {
                            ...
                            if (a.player.template.unlimitDanmakuToggle.checked) {
                                a.player.template.unlimitDanmaku.classList.remove("off")
                            } else {
                                a.player.template.unlimitDanmaku.classList.add("off")
                            }
                            ;
                        }));
                ...
                var Le = function () {
                        ...
                        (a = [{
                            ...
                            },
                            {
                                key: "update",
                                value: function () {
                                    this.template.infoVersion.innerHTML = "".concat("宏仔", " ").concat(""),
                        ...
                        (a = [{
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    this.video.paused || o.isMobile || this.bezel.switch(U.pause),
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    else switch ("auto" === this.type && (/m3u8(#|\?|$)/i.exec(e.src) ? this.type = "M3U8" : /.flv(#|\?|$)/i.exec(e.src) ? this.type = "flv" : /.mpd(#|\?|$)/i.exec(e.src) ? this.type = "dash" : this.type = "MP4"), "M3U8" === this.type && (e.canPlayType("application/x-mpegURL") || e.canPlayType("application/vnd.apple.mpegURL")) && (this.type = "normal"), this.type) {
                                        case "M3U8":
